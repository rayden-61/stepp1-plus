...
local function func()
	...
	-- blanks
	--if (Noteskin.bBlanks[sElement] and (not (string.find(sElement,"Topcap") and sButton == "Center"))) or (sElement == "Receptor" and sButton ~= "Center") or
	...
	if string.find(sElement,"Hold Head") and sButton == "Center" then
		ElementToLoad = "Hold Head Active"
	else
		ElementToLoad = Noteskin.ElementRedirs[sElement]
